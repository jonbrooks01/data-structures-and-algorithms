...
const typeNum = (arr) => {
  // Solution code here...
  let number1 = arr.filter(num => (num % 1) === 0);
  return number1;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let string = arr.filter(and => and.includes('and'))
  return string;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let newAr = arr.filter(x => !forbiddenValues.includes(x));
  return newAr;
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here..
  let higherStat = arr.filter(pokemon => pokemon.baseStat > minBaseStat);
  return higherStat;
};
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  let higherStat = arr.filter(pokemon => pokemon.baseStat > minBaseStat);
  let statName = higherStat.map(pokemon => pokemon.stat.name)
  return statName;
};
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  const noKids = arr.filter(character => {
